<template>
  <div class="container mx-auto wrapper flex gap-4 flex-col">
  <div class="flex flex-col gap-2">
    <h1 class="text-center font-bold text-5xl text-[#132238]">Blog</h1>
    <div class="header_p justify-center flex">
      <p
        class="text-center text-[#87909D] text-[18px] w-[540px] justify-center"
      >
  ...
  <div class="articles flex flex-row gap-5">
    <div class="about__post w-[315px] bg-white shadow-2xl">
        <img src="../../assets/unsplash_phIFdC6lA4E.png" alt="unsplash1">
